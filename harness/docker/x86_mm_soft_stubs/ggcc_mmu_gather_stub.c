...
/* stub for mm/mmu_gather.c */
STUB4(__tlb_remove_folio_pages)
STUB4(__tlb_remove_page_size)
STUB4(tlb_finish_mmu)
STUB4(tlb_flush_mmu)
STUB4(tlb_flush_rmaps)
STUB4(tlb_gather_mmu)
STUB4(tlb_gather_mmu_fullmm)
STUB4(tlb_remove_table)
STUB4(tlb_remove_table_sync_one)
